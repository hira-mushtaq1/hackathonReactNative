const LocationModel = require('../models/OrderModel');

const LocationController = {
  CreateLocation: (request, response) => {
    const {currLatitude, currLongitude, category, createdAt} = request.body;

    console.log(request.body);

    if (!currLatitude || !currLongitude || !category || !createdAt) {
      response.json({
